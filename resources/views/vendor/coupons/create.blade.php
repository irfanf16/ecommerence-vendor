                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label for="product_variant_id">SKU's<sup class="text-danger">*</sup>
                                                </label>
                                            </div>
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <select class="form-control show-tick ms " name="product_variant_id"
                                                            id="product_variant_id" required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" name="code" id="code"
                                                            class="form-control counter" placeholder="" maxlength="10"
                                                            required>
