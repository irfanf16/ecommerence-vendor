            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="header order-header">
                        <h2 class="d-inline"><strong>Product Reviews</strong></h2>
                    </div>
                    {{-- warning message row --}}
                                        ...
                                        <table id="example-datatable"
                                            ...
                                            @foreach ($reviews as $rev)
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">
                                                        <img
                                                            src="{{$imagesUrl}}/storage/product/images/sm/{{$rev->product_detail->primary_image}}"
                                                            alt="" class=" rounded w-100">
                                                    </td>
                                                    <td><strong>Product</strong> {{$rev->product_detail->name}}</td>
                                                    <td><strong>{{ $rev->customer_review }}</strong></td>
                                                    <td width="10%">
                                                        <img
                                                            src="{{$imagesUrl}}/storage/images/products/reviews/lg/{{$rev->images[0]->image ?? 'default.png'}}"
                                                            alt="" class=" rounded w-100">
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if (!$rev->vendor_reply)
                                                            <button data-id="{{$rev->id}}" title="Edit This Product"
                                                                    class="btn btn-primary btn-sm m-1 reviewReply">Reply
                                                            </button>
                                                        @endif
                                                    </td>
                                                </tr>
