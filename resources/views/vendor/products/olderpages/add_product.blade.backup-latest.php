                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10 custom-padding-brand">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="attributes[]" class="form-control show-tick ms select2"
                                                            ...
                                                            <tr>
                                                                <td class="">
                                                                    <label class="toggle-switch ml-3">
                                                                        <input name="holiday_mode" id="holiday_mode"
                                                                            type="checkbox">
                                                                        <span
                                                                            class="toggle-switch-slider rounded-circle"></span>
                                                                    </label>
                                                                </td>
                                                                <td class="dynamic-content">
                                                                    <input type="text" class="form-control" name=""
                                                                        id="" placeholder="Please Enter">
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control" name=""
                                                                        id="" placeholder="Please Enter">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select class="form-control show-tick ms select2"
                                                                ...
                                                                <option>Life Time Warranty</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control"
                                                                name="package_contents" id="package_contents" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label for="package_dimensions_lenght"
                                                            class="control-label float-right">Package
                                                            Dimensions
                                                            (cm)<sup class="text-danger">*</sup></label>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="number" min="0" step="0.01"
                                                            name="package_dimensions_lenght"
                                                            id="package_dimensions_lenght" placeholder="Lenght (cm)"
                                                            required>
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="number" min="0" step="0.01"
                                                            ...
                                                            id="package_dimensions_width" placeholder="Width (cm)"
                                                            required>
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="number" min="0" step="0.01"
                                                            ...
                                                            id="package_dimensions_height" placeholder="Height (cm)"
                                                            required>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <label for="warranty_period"
                                                                ...
                                                                Goods<sup class="text-danger">*</sup></label>
                                                        </div>
                                                        <div class="col-md-9">
                                                            {{-- Battery --}}
                                                            ...
                                                            Flammable
                                                            {{-- Liquid --}}
                                                            <input type="checkbox" class="ml-2" name="liquid"
                                                                id="liquid">
                                                            Liquid
                ...
                box.after(`
                    <td class="dynamic-col">
                        <div class="form-group">
                            <select id="${unique_string(8)}" class="form-control" name="">
                                ${options}
                            </select>
                        </div>
                    </td>
