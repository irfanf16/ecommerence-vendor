                        ...
                        <h6>
                            ...
                            @if ($store_info)
                                ...
                                {{-- <a href="{{ URL::to('/vendor/product/upload-csv') }}"
                                    ...
                                    File</a> --}}
                            @else
                                <a data-toggle="modal" data-target="#createStoreModal" title="Go to Add New Product Page"
                                    class="btn btn-primary float-right text-white">Add Product</a>
                                {{-- <a href="{{ URL::to('/vendor/product/upload-csv') }}"
                                    title="Go to Product CSV File Upload Page" class="btn btn-success float-right mx-2">Add
                                    CSV
                                    File</a> --}}
                                    ...
                                    @foreach ($products as $product)
                                        ...
                                        @foreach ($product->variants as $variant)
                                            <tr>
                                                ...
                                                <td style="width:40%">
                                                    {{ \Illuminate\Support\Str::limit($product->name, $limit = 70, $end = '...') }}<br>
                                                ...
                                                <td>
                                                    {{-- @if ($variant->availability) Original condition --}}
                                                    @if (1 == 1)
                                                        <span
                                                            class="text-success text-uppercase font-weight-bold">Yes</span>
                                                    @else
                                                        <span
                                                ...
                                                <td>
                                                    ...
                                                    @can('products.manage_products', 'update')
                                                        <a href="{{ URL::to("vendor/products/$variant->id/edit") }}"
