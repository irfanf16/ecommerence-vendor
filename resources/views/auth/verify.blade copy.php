            ...
            <div class="row">
                <div class="col-md-8 ">
                    <div class="signup-image">
                        ...
                        <h2>Storak Help Center </h2>
                        <img src="{{ asset('/vendor/images/resetPassword/otp.svg') }}" alt="signup image"
                            class="img-fluid">
                    </div>
                </div>
                    ...
                    <div class="card mt-5 border-0">
                        ...
                        <div class="card-body login-form-body">
                            ...
                            <form action="{{ url('/mobile/verify') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="number" class="form-control shadow-none" id="mobile_otp" name="mobile_otp"
