    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 mx-auto ">
                <div class="col-md-10 mx-auto p-4" style="background-color: #FD8F1F">
                    <div class="card">
                        <div class="col-md-12 mx-auto mt-4 mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-2  mx-auto">
                                    <img src="{{ url('/vendor/images/logos/logo.svg') }}" class="img-fluid" alt="storak"
                                        width="140px">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group row mb-4 mx-auto">
                                    <div class="col-md-6 offset-md-4 ">
                                        ...
                                        <a class="btn btn-primary" style="background-color: #3b5998;"
                                            href="{{ route('social.oauth', 'facebook') }}" role="button"><i
                                                class="fab fa-facebook-f"></i></a>
                                        <!-- Google -->
                                        <a class="btn btn-primary" style="background-color: #dd4b39;"
                                            href="{{ route('social.oauth', 'google') }}" role="button"><i
