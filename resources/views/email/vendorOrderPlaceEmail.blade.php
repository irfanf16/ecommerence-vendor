                                ...
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="7681" align="center">
                                        <table class="es-header-body" style="background-color: #044767;" width="600"
                                            cellspacing="0" cellpadding="0" bgcolor="#044767" align="left">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="{{ URL::to('/assets/images/storaklogo/preloader.svg') }}"
                                                            alt="" width="125">
                                                    </td>
                                                    <td class="es-m-p0r es-m-p20b esd-container-frame" width="340"
                                                        valign="top" align="left">
                                                        <h1
                                                            style="color: #ffffff; line-height: 100%; text-align: left ">
                                                            Storak</h1>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-infoblock made_with"
                                                                                        ...
                                                                                        style="font-size:0"><a
                                                                                            target="_blank"
                                                                                            href="{{ url('/vendor/images/bg/storaklogo/preloader.svg') }}"
                                                                                            alt width="125"></a>
                                                                                        <img src="{{ URL::to('/assets/images/storaklogo/preloader.svg') }}"
                                                                                            alt="" width="125">
                                                                                    </td>
