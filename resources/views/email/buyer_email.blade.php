                ...
                <td>
                    <table width="600" align="center" cellpadding="15" cellspacing="0" border="0" class="devicewidth"
                        ...
                        <tbody>
                                ...
                                <td style="padding-top: 30px;">
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <h2>Congrats! Your Order is placed</h2>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    Order Number: <strong style="color: #000000">#056701</strong> |
                                                    Order Date:
                                                    <strong style="color: #000000">21-Nov-19</strong>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td
                                                    style="width: 45%; font-size: 14px; font-weight: bold; color: #000000; padding-bottom: 5px;">
                                                    Billing Address
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="width: 55%; font-size: 12px; line-height: 18px; color: #666666;">
                                                    James C Painter
                                                </td>
                                                <td
                                                    style="width: 45%; font-size: 12px; line-height: 18px; color: #666666;">
                                                    James C Painter
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td
                                                    style="width: 55%; font-size: 12px; line-height: 18px; color: #666666; padding-bottom: 10px;">
                                                    Michigan, 48335
                                                </td>
                                                <td
                                                    style="width: 45%; font-size: 12px; line-height: 18px; color: #666666; padding-bottom: 10px;">
                                                    Michigan, 48335
                                                </td>
                                            </tr>
                                        </tbody>
                                            ...
                                            @for ($i = 0; $i < 5; $i++)
                                                <tr>
                                                    <td style="font-size: 12px; line-height: 16px; color: #1b1313;">
                                                        <strong> Package ID:</strong> #0021155
                                                    </td>

                                                </tr>
                                                <tr>
                                                    <td style="font-size: 12px; line-height: 16px; color: #1b1313; ">
                                                        <strong>Store :</strong>SAMSUNG
                                                    </td>

                                                </tr>
                                                <tr>
                                                    <td style="font-size: 12px; line-height: 16px; color: #1b1313; ">
                                                        <strong style="">Shipping
                                                            charges:</strong>550
                                                    </td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <th
                                                                        ...
                                                                        <strong>455112</strong>
                                                                    </th>
                                                                    <th
                                                                        style="font-size: 11px; line-height: 16px; color: #757575; width:10%">
                                                                        <strong>140123</strong>
                                                                    </th>
                                                                    <th
                                                                        style="font-size: 11px; line-height: 16px; color: #757575; width:10%">
                                                                        <strong>7</strong>
                            ...
                            <tr>
                                <td colspan="2"
                                    style="font-size: 12px; line-height: 45px; color: #757575; text-align: center">
                                    <strong>Sub total:</strong> $5650
                                    <hr>
                                </td>
                            </tr>
                            @endfor
